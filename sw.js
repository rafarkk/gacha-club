...
const CACHE = 'atelie-estelar-v3';
const ASSETS = [
  './', './index.html', './manifest.webmanifest', './icon.svg', './css/style.css',
  './js/core/core.js', './js/core/store.js',
  './js/rig/parts-hair.js', './js/rig/parts-face.js', './js/rig/parts-body.js', './js/rig/parts-acc.js', './js/rig/parts-pets.js', './js/rig/rig.js',
  './js/data/poses.js', './js/data/defaults.js', './js/data/backgrounds.js',
  './js/ui/colorpicker.js', './js/ui/modals.js', './js/ui/menu.js', './js/ui/editor.js', './js/ui/editor-panels.js', './js/app.js',
];
