...
function hairGloss(k, cx = 150, cy = 128, rx = 72, ry = 68, ang = [230, 251, 272], len = [7, 11, 8]) {
  const col = k.HL || Color.mix(k.c[0], '#ffffff', .62);
...
PARTS.hairBack = [null,
  ...
  { n: 'Tranças', d: k => [86, 214].map((x, i) => braid(k, [[x, 190], [x + (i ? 2 : -2), 208], [x + (i ? 3 : -3), 226], [x + (i ? 3 : -3), 244], [x + (i ? 2 : -2), 262], [x, 280]], 12) + `<ellipse cx="${x}" cy="${291}" rx="7" ry="4.5" fill="${k.ACC || k.c[1]}" ${ol(k, 2.2)}/>`).join('') },
  ...
  { n: 'Longo com fita', d: k => hair(k, CAP_BACK, [[226, 128], [238, 250], [244, 332], [216, 342], [184, 346], [150, 348], [116, 346], [84, 342], [56, 332], [62, 250], [74, 128]], { top: 150, shine: 0, bulge: .25 }) + P(k, 'M150 300 L126 288 L126 312Z M150 300 L174 288 L174 312Z', k.ACC || k.c[1]) + `<circle cx="150" cy="300" r="5" fill="${k.ACC || k.c[1]}" ${ol(k, 1.6)}/>` },
  ...
  { n: 'Longo com laço baixo', d: k => hair(k, CAP_BACK, [[226, 128], [230, 250], [216, 300], [196, 330], [176, 346], [150, 352], [124, 346], [104, 330], [84, 300], [70, 250], [74, 128]], { top: 150, shine: 0, bulge: .4 }) + P(k, 'M150 250 L126 238 L126 262Z M150 250 L174 238 L174 262Z', k.ACC || k.c[1]) },
...
PARTS.hairBase = [null,
  ...
  /* ---- rodada 3 (fase 5) ---- */
  { n: 'Repicado curto', d: k => hair(k, CAP_BASE, [[238, 150], [252, 176], [236, 172], [242, 198], [222, 186], [218, 208], [198, 192], [150, 196], [102, 192], [82, 208], [78, 186], [58, 198], [64, 172], [48, 176], [62, 150]], { top: 60, bulge: .1, shine: 0 }) },
  { n: 'Ombro liso', d: k => hair(k, CAP_BASE, [[238, 150], [244, 222], [236, 244], [216, 236], [150, 240], [84, 236], [64, 244], [56, 222], [62, 150]], { top: 60, bulge: .3, shine: 0 }) },
  { n: 'Ondulado curto', d: k => hair(k, CAP_BASE, [[238, 150], [256, 172], [240, 190], [254, 208], [230, 214], [212, 206], [150, 208], [88, 206], [70, 214], [46, 208], [60, 190], [44, 172], [62, 150]], { top: 60, bulge: .7, shine: 0 }) },
  { n: 'Pontas para fora', d: k => hair(k, CAP_BASE, [[238, 150], [242, 196], [266, 216], [238, 214], [222, 220], [150, 214], [78, 220], [62, 214], [34, 216], [58, 196], [62, 150]], { top: 60, bulge: .3, shine: 0 }) },
  { n: 'Topete alto', d: k => hair(k, 'M58 150 C44 56 100 4 158 10 C222 18 256 70 242 150', [[242, 150], [252, 180], [232, 176], [224, 196], [150, 190], [76, 196], [68, 176], [48, 180], [58, 150]], { top: 40, bulge: .3, shine: 0 }) },
  { n: 'Desgrenhado', d: k => hair(k, 'M54 150 C36 70 84 26 150 24 C216 26 264 70 246 150', [[246, 150], [266, 164], [248, 172], [262, 192], [238, 190], [240, 212], [216, 198], [204, 216], [188, 198], [150, 200], [112, 198], [96, 216], [84, 198], [60, 212], [62, 190], [38, 192], [52, 172], [34, 164], [54, 150]], { top: 50, bulge: .15, shine: 0 }) },
  { n: 'Afro', d: k => curls(k, [[70, 96, 30], [62, 136, 30], [70, 176, 28], [230, 96, 30], [238, 136, 30], [230, 176, 28], [96, 52, 32], [130, 32, 32], [170, 32, 32], [204, 52, 32], [150, 110, 86]]) },
  { n: 'Chanel reto', d: k => hair(k, CAP_BASE, [[238, 150], [242, 216], [150, 222], [58, 216], [62, 150]], { top: 60, bulge: .15, shine: 0 }) },
  { n: 'Mullet', d: k => hair(k, CAP_BASE, [[238, 150], [246, 196], [232, 190], [240, 250], [220, 238], [214, 262], [196, 236], [150, 238], [104, 236], [86, 262], [80, 238], [60, 250], [68, 190], [54, 196], [62, 150]], { top: 60, bulge: .15, shine: 0 }) },
  { n: 'Espetado macio', d: k => hair(k, 'M56 150 C40 60 92 18 150 18 C208 18 260 60 244 150', [[244, 150], [264, 150], [248, 170], [262, 188], [236, 184], [226, 202], [150, 196], [74, 202], [64, 184], [38, 188], [52, 170], [36, 150], [56, 150]], { top: 45, bulge: .2, shine: 0 }) },
  { n: 'Coque de cima', d: k => hair(k, CAP_BASE, [[238, 150], [244, 180], [150, 186], [56, 180], [62, 150]], { top: 60, bulge: .3, shine: 0 }) + `<circle cx="150" cy="22" r="22" fill="${k.F}" ${ol(k, 3)}/><path d="M136 18 Q150 8 164 18" stroke="${k.c[2]}" stroke-opacity=".45" stroke-width="1.8" fill="none"/>` },
  { n: 'Longo liso', d: k => hair(k, CAP_BASE, [[238, 150], [244, 250], [248, 290], [226, 282], [150, 286], [74, 282], [52, 290], [56, 250], [62, 150]], { top: 60, bulge: .2, shine: 0 }) },
];

/* Rabo de cavalo / penteados presos */
PARTS.ponytail = [null,
  { n: 'Rabo alto', d: k => hair(k, 'M176 56 C224 14 294 48 286 128', [[286, 128], [292, 196], [276, 182], [280, 250], [260, 222], [258, 278], [240, 236], [232, 256], [224, 172], [206, 96], [182, 80]], { top: 64, bulge: .18, shine: 0, sw: -2 }) + `<ellipse cx="188" cy="66" rx="8" ry="11" fill="${k.ACC || k.c[1]}" ${ol(k, 2.4)} transform="rotate(35 188 66)"/>` },
  { n: 'Maria-chiquinha', d: k => [0, 1].map(m => { const p = hair(Object.assign({}, k, { u: k.u + m }), 'M92 92 C44 94 24 162 36 232', [[36, 232], [48, 262], [52, 240], [62, 256], [62, 218], [70, 150], [96, 118]], { top: 110, bulge: .3, shine: 0 }) + `<circle cx="86" cy="96" r="8" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  ...
  { n: 'Trança lateral', d: k => braid(k, [[80, 172], [83, 192], [86, 212], [89, 232], [92, 252], [95, 272]], 13) + `<ellipse cx="95" cy="284" rx="7.5" ry="4.8" fill="${k.ACC || k.c[1]}" ${ol(k, 2.2)}/>` },
  { n: 'Rabo de lado', d: k => hair(k, 'M86 104 C40 144 36 226 60 280', [[60, 280], [70, 300], [74, 276], [84, 290], [88, 240], [94, 184], [100, 150]], { top: 120, bulge: .3, shine: 0 }) + `<circle cx="86" cy="116" r="8" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  { n: 'Chiquinhas curtas', d: k => [0, 1].map(m => { const p = hair(Object.assign({}, k, { u: k.u + m }), 'M88 86 C58 78 42 104 44 134', [[44, 134], [48, 150], [56, 136], [64, 146], [70, 126], [80, 124], [92, 98]], { top: 96, bulge: .4, shine: 0 }) + `<circle cx="86" cy="90" r="6" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  { n: 'Rabo gigante', d: k => hair(k, 'M180 54 C258 4 318 90 304 190', [[304, 190], [306, 270], [290, 250], [288, 340], [266, 300], [262, 352], [244, 302], [236, 322], [224, 172], [206, 94], [186, 80]], { top: 64, bulge: .18, shine: 0, sw: -2 }) + `<ellipse cx="190" cy="66" rx="9" ry="12" fill="${k.ACC || k.c[1]}" ${ol(k, 2.4)} transform="rotate(35 190 66)"/>` },
  /* ---- recriados a partir do Gacha Club ---- */
  { n: 'Rabo baixo', d: k => hair(k, 'M180 150 C220 150 240 190 236 250', [[236, 250], [240, 300], [226, 290], [222, 330], [210, 300], [202, 320], [200, 240], [190, 180], [178, 164]], { top: 160, bulge: .3, shine: 0 }) + `<ellipse cx="190" cy="168" rx="7" ry="9" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  { n: 'Chiquinhas longas onduladas', d: k => [0, 1].map(m => { const p = hair(Object.assign({}, k, { u: k.u + 'w' + m }), 'M88 88 C40 90 24 150 44 200', [[44, 200], [26 , 250], [46, 296], [34, 334], [52, 330], [62, 300], [58, 260], [72, 210], [80, 150], [96, 116]], { top: 110, bulge: .5, shine: 0 }) + `<circle cx="86" cy="94" r="8" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  ...
  { n: 'Trança embutida', d: k => braid(k, [[150, 196], [150, 214], [150, 232], [150, 250], [150, 268], [150, 286], [150, 304]], 12) + `<ellipse cx="150" cy="318" rx="7" ry="4.5" fill="${k.ACC || k.c[1]}" ${ol(k, 2.2)}/>` },
  ...
  { n: 'Rabo alto cacheado', d: k => curls(k, [[200, 70, 16], [220, 90, 18], [232, 120, 18], [236, 150, 18], [232, 180, 16], [226, 206, 14], [218, 228, 12]]) + `<ellipse cx="192" cy="68" rx="8" ry="10" fill="${k.ACC || k.c[1]}" ${ol(k, 2.2)}/>` },
  ...
  { n: 'Rabo duplo alto', d: k => [0, 1].map(m => { const p = hair(Object.assign({}, k, { u: k.u + 'd' + m }), 'M104 48 C60 30 30 70 34 130', [[34, 130], [30, 176], [44, 162], [46, 200], [58, 170], [66, 184], [66, 120], [80, 76], [100, 64]], { top: 60, bulge: .3, shine: 0 }) + `<ellipse cx="102" cy="56" rx="7" ry="9" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  /* ---- rodada 2 ---- */
  { n: 'Rabo alto curto', d: k => hair(k, 'M180 60 C220 30 262 60 258 110', [[258, 110], [262, 150], [244, 136], [242, 166], [226, 144], [214, 100], [186, 84]], { top: 70, bulge: .3, shine: 0 }) + `<ellipse cx="188" cy="68" rx="7" ry="9" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  { n: 'Chiquinhas de trança', d: k => [0, 1].map(m => { const p = braid(Object.assign({}, k), [[70, 110], [66, 132], [64, 154], [64, 176], [66, 198], [70, 220]], 11) + `<ellipse cx="70" cy="232" rx="6" ry="4" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  ...
  { n: 'Meio preso', d: k => hair(k, 'M176 70 C214 60 230 100 222 150', [[222, 150], [226, 200], [212, 186], [208, 220], [198, 150], [190, 100], [178, 84]], { top: 90, bulge: .3, shine: 0 }) + `<circle cx="180" cy="76" r="7" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  { n: 'Rabo lateral cacheado', d: k => curls(k, [[216, 110, 14], [226, 136, 16], [230, 164, 16], [228, 192, 14], [222, 216, 12]]) + `<circle cx="210" cy="100" r="7" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  { n: 'Coques de estrela', d: k => [90, 210].map(x => `<path d="${Shape.star(x, 54, 26, 14)}" fill="${k.F}" ${ol(k, 2.6)}/>`).join('') },
  { n: 'Chiquinhas gigantes', d: k => [0, 1].map(m => { const p = hair(Object.assign({}, k, { u: k.u + 'g' + m }), 'M90 84 C20 70 -10 170 20 290', [[20, 290], [34, 340], [46, 310], [60, 330], [64, 250], [72, 160], [96, 110]], { top: 100, bulge: .35, shine: 0 }) + `<circle cx="88" cy="90" r="9" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>`; return m ? `<g transform="translate(300 0) scale(-1 1)">${p}</g>` : p; }).join('') },
  { n: 'Rabo trançado', d: k => braid(k, [[204, 88], [222, 104], [234, 126], [240, 150], [242, 174], [242, 198], [240, 222]], 11) + `<ellipse cx="240" cy="236" rx="6" ry="4" fill="${k.ACC || k.c[1]}" ${ol(k, 2)}/>` },
  ...
  /* ---- padrões do Gacha Club ---- */
  { n: 'Rabo alto de lado', d: k => hair(k, 'M120 40 C104 2 56 6 46 60', [[46, 60], [36, 102], [52, 94], [52, 132], [64, 108], [72, 140], [76, 100], [92, 72], [114, 60]], { top: 36, bulge: .3, shine: 0, sw: 2 }) + `<ellipse cx="106" cy="44" rx="7" ry="11" fill="${k.ACC || '#ff4f86'}" ${ol(k, 2.2)} transform="rotate(-50 106 44)"/>` },
];
...
PARTS.bangs = [null,
  ...
  { n: 'Franja com presilha', d: k => hair(k, CAP_BANGS, [[230, 150], [224, 176], [212, 112], [196, 132], [182, 98], [164, 128], [150, 96], [134, 128], [118, 98], [102, 132], [88, 112], [76, 176], [70, 150]], { edgeOnly: 1, bulge: .45 }) + `<rect x="184" y="84" width="24" height="7" rx="3" fill="${k.ACC || k.c[1]}" ${ol(k, 1.6)} transform="rotate(-20 196 88)"/>` },
