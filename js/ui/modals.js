...
const Modals = (() => {
  ...
  const TUT = [
    ...
    { t: 'Estúdio', say: 'No Estúdio você vai montar cenas com vários personagens.', list: ['Coloque personagens em qualquer lugar da tela.', 'Adicione mascotes e objetos.', 'Escolha fundos e sobreposições (chuva, neve, pétalas...).', 'Faça os personagens conversarem com balões de fala.', 'Use um narrador para contar histórias.', 'Salve até 15 cenas e exporte como imagem.'], pet: 'As possibilidades são infinitas!' },
