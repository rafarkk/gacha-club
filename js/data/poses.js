...
const POSES = [
  ...
  // ---------- Agachado ----------
  { n: 'Agachado', c: 'Agachado', a: [30, -80, 30, -80], l: [40, -70, 40, -70], ls: [.7, .8, .7, .8], y: 33 },
  { n: 'De cócoras', c: 'Agachado', a: [20, -110, 20, -110], l: [52, -100, 52, -100], ls: [.55, .7, .55, .7], y: 48, hd: [1, 1] },
  { n: 'Ajoelhado', c: 'Agachado', a: [14, -30, 14, -30], l: [6, 0, 6, 0], ls: [1, .25, 1, .25], y: 40 },
  { n: 'Um joelho', c: 'Agachado', a: [26, -60, 12, -10], l: [30, -70, 4, 0], ls: [.8, .9, 1, .3], y: 28 },
  // ---------- Sentado ----------
  { n: 'Sentado no chão', c: 'Sentado', a: [26, -10, 26, -10], l: [40, 30, 40, 30], ls: [.3, .8, .3, .8], y: 43 },
  { n: 'Pernas cruzadas', c: 'Sentado', a: [30, -70, 30, -70], l: [70, -120, 70, -120], ls: [.35, .6, .35, .6], y: 63 },
  { n: 'Sentado na cadeira', c: 'Sentado', a: [20, -50, 20, -50], l: [4, 0, 4, 0], ls: [.3, 1, .3, 1], y: 38 },
  { n: 'Abraçando joelhos', c: 'Sentado', a: [-10, -60, -10, -60], l: [18, -30, 18, -30], ls: [.3, .5, .3, .5], y: 58, h: 8 },
  { n: 'Balançando pés', c: 'Sentado', a: [30, -20, 30, -20], l: [8, 16, 0, -12], ls: [.3, 1, .3, 1], y: 38, h: -4 },
  // ---------- Deitado ----------
  { n: 'Dormindo', c: 'Deitado', a: [10, 0, 30, -20], l: [3, 0, 8, -6], r: -90, y: 118, x: 46 },
  { n: 'Deitado de bruços', c: 'Deitado', a: [120, 60, 120, 60], l: [6, 20, 6, 30], r: 90, y: 118, x: -46 },
  { n: 'Esparramado', c: 'Deitado', a: [90, 0, 90, 0], l: [30, 0, 30, 0], r: -90, y: 118, x: 46 },
  // ---------- Pulando / Voando ----------
