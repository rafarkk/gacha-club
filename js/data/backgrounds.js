...
const Scenery = (() => {
  ...
  const WIDE = {
    ...
    aurora: (c, u) => {
      ...
      s += `<path d="M-60 360 Q200 300 480 340 Q720 370 1020 320 L1020 560 L-60 560Z" fill="url(#${u}sn2)"/><path d="M480 340 Q720 370 1020 320 L1020 380 Q720 410 480 380Z" fill="#a8b8d0" opacity=".5"/>`;
      s += `<path d="M-60 440 Q300 380 600 420 Q820 450 1020 410 L1020 560 L-60 560Z" fill="url(#${u}sn)"/><path d="M-60 440 Q300 380 600 420" stroke="#fff" stroke-width="5" fill="none"/><path d="M600 420 Q820 450 1020 410 L1020 460 Q820 490 600 470Z" fill="#b8c8e0" opacity=".45"/>`;
