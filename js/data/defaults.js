...
const DEFAULT_GIRL = () => look({ bust: 1, name: 'Menina Padrão', s: '#ffe8dc', h: [29, 0, 29, 33, 1], hc: ['#958af4', '#6c78e8', '#1c2350'], e: 2, lash: '#1c1a3a', p: 1, ic: ['#e0209a', '#ff9ad8', '#4a0a3a'], b: 2, bc: '#1c2350', m: 1, bl: 1, blc: '#ff8fa3', shirt: [36, '#ff7ac8', '#e0409a'], sleeve: [21, '#ff7ac8', '#e0409a'], logo: [28, '#ffffff', '#ff7ac8'], skirt: [1, '#c0147a', '#8a0a58'], pants: [1, '#3f7fe0', '#9cc4ff'], sock: [14, '#ffffff', '#b0106a'], shoe: [19, '#8a5a3a', '#5a3a22'], profile: { bio: 'Olá! Eu sou a menina padrão do Ateliê.', creator: 'Ateliê', color: 'Rosa', food: 'Morango', place: 'Brasil', personality: 'Alegre', job: 'Estudante' } });
